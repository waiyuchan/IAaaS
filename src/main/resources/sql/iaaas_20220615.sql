...
CREATE TABLE `ac_building` (
  ...
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公寓名称',
  `eng_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公寓英文名',
  ...
  `address` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公寓地址',
  `postcode` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公寓邮编',
  `owner` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '公寓负责人',
...
-- ----------------------------
BEGIN;
INSERT INTO `ac_building` VALUES (1, '维噶', 'Vega', '07419370700', 'vega@gmail.com', 'Vega, 4 Miles Street, London', 'SW8 1GH', 'admin', 40, 600, 0, '2022-05-29 23:51:57', '2022-05-29 17:10:54');
INSERT INTO `ac_building` VALUES (2, '阿特乐思', 'Atlas', '07419370710', 'atlas@gmail.com', 'Atlas, 5 Miles Street, London', 'SW7 2GH', 'admin', 50, 730, 0, '2022-05-29 23:51:57', '2022-05-29 17:10:56');
COMMIT;
...
CREATE TABLE `ac_user` (
  ...
  `mobile_phone` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '手机号码',
...
-- ----------------------------
-- Table structure for ae_resource
-- ----------------------------
DROP TABLE IF EXISTS `ae_resource`;
CREATE TABLE `ae_resource` (
  `id` int NOT NULL AUTO_INCREMENT,
  `category_id` int DEFAULT NULL COMMENT '资源分类ID',
  `name` varchar(100) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '资源名称',
  ...
  PRIMARY KEY (`id`),
  KEY `res_category_id_fgk` (`category_id`),
  CONSTRAINT `res_category_id_fgk` FOREIGN KEY (`category_id`) REFERENCES `ae_resource_category` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- ----------------------------
-- Table structure for ae_resource_category
-- ----------------------------
DROP TABLE IF EXISTS `ae_resource_category`;
CREATE TABLE `ae_resource_category` (
  `id` int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `ae_role_menu_relation` (
  ...
  PRIMARY KEY (`id`),
  KEY `rmr_role_id_fgk` (`role_id`),
  KEY `rmr_menu_id_fgk` (`menu_id`),
  CONSTRAINT `rmr_menu_id_fgk` FOREIGN KEY (`menu_id`) REFERENCES `ae_ms_menu` (`id`),
  CONSTRAINT `rmr_role_id_fgk` FOREIGN KEY (`role_id`) REFERENCES `ae_staff_role` (`id`)
...
CREATE TABLE `ae_role_permission_relation` (
  ...
  PRIMARY KEY (`id`),
  KEY `rpr_role_id_fgk` (`role_id`),
  KEY `rpr_per_id_fgk` (`permission_id`),
  CONSTRAINT `rpr_per_id_fgk` FOREIGN KEY (`permission_id`) REFERENCES `ae_staff_permission` (`id`),
  CONSTRAINT `rpr_role_id_fgk` FOREIGN KEY (`role_id`) REFERENCES `ae_staff_role` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `ae_role_permission_relation` VALUES (1, 1, 1);
COMMIT;

-- ----------------------------
-- Table structure for ae_role_resource_relation
-- ----------------------------
DROP TABLE IF EXISTS `ae_role_resource_relation`;
CREATE TABLE `ae_role_resource_relation` (
  `id` int NOT NULL AUTO_INCREMENT,
  `role_id` int DEFAULT NULL COMMENT '角色ID',
  `resource_id` int DEFAULT NULL COMMENT '资源ID',
  PRIMARY KEY (`id`),
  KEY `rrr_role_id_fgk` (`role_id`),
  KEY `rrr_res_id_fgk` (`resource_id`),
  CONSTRAINT `rrr_res_id_fgk` FOREIGN KEY (`resource_id`) REFERENCES `ae_resource` (`id`),
  CONSTRAINT `rrr_role_id_fgk` FOREIGN KEY (`role_id`) REFERENCES `ae_staff_role` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
-- ----------------------------
BEGIN;
INSERT INTO `ae_staff` VALUES (1, 'admin', '$2a$10$uUHup8.ojRUBFDhLSg21l.UBqOKxnuPVsJC1mVhDcjfg3sBfoN7cC', '老陈', 'will', '2022-01-29', 'GUANGDONG', '中国', 'passport', 'AB1235709', 'test@gmail.com', '13590023455', 'Vega, 4 Miles Street, London', 'SW8 1GH', '总裁办', 000, '2022-05-29 23:32:08', '2022-06-15 11:55:19');
COMMIT;
...
CREATE TABLE `ae_staff_login_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `login_log_staff_id_fgk` (`staff_id`),
  CONSTRAINT `login_log_staff_id_fgk` FOREIGN KEY (`staff_id`) REFERENCES `ae_staff` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `ae_staff_permission` VALUES (1, 0, '超级管理员', 'manage:*', 0, '/*', 0, '2022-06-09 23:00:33', '2022-06-15 11:59:49');
COMMIT;
...
CREATE TABLE `ae_staff_role` (
  ...
  `desc` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '描述',
...
-- ----------------------------
BEGIN;
INSERT INTO `ae_staff_role` VALUES (1, '总裁', '企业级别，高层，4级管理者，职级：4-2', 0, 0, '2022-06-06 09:10:37', '2022-06-06 09:23:02');
INSERT INTO `ae_staff_role` VALUES (2, '副总裁', '企业级别，高层，4级管理者，职级：4-1', 0, 0, '2022-06-06 09:11:36', '2022-06-06 09:23:08');
INSERT INTO `ae_staff_role` VALUES (3, '总经理', '企业级别，中层，3级管理者，职级：3-2', 0, 0, '2022-06-06 09:13:15', '2022-06-06 09:23:10');
INSERT INTO `ae_staff_role` VALUES (4, '副总经理', '企业级别，中层，3级管理者，职级：3-1', 0, 0, '2022-06-06 09:13:30', '2022-06-06 09:23:12');
INSERT INTO `ae_staff_role` VALUES (5, '总监', '企业-部门级别，基层，部门总监，2级管理者，职级：2-2', 0, 0, '2022-06-06 09:14:26', '2022-06-06 09:23:19');
INSERT INTO `ae_staff_role` VALUES (6, '副总监', '企业-部门级别，基层，部门副总监，2级管理者，职级：2-1', 0, 0, '2022-06-06 09:15:31', '2022-06-06 09:23:21');
INSERT INTO `ae_staff_role` VALUES (7, '组长', '企业-部门-小组级别，基层，小组组长，1级管理者，职级：1-2', 0, 0, '2022-06-06 09:16:53', '2022-06-06 09:23:24');
INSERT INTO `ae_staff_role` VALUES (8, '公寓经理', '企业-部门-小组-公寓级别，基层，公寓管理者，1级管理者，职级：1-1', 0, 0, '2022-06-06 09:17:09', '2022-06-06 09:26:22');
INSERT INTO `ae_staff_role` VALUES (9, '公寓运营人员', '企业-部门-小组-公寓级别，非管理者，任务为公寓的日常运营工作', 0, 0, '2022-06-06 09:18:15', '2022-06-06 09:32:08');
INSERT INTO `ae_staff_role` VALUES (10, '公寓维修人员', '企业-部门-小组-公寓级别，非管理者，任务为公寓的日常维修工作', 0, 0, '2022-06-06 09:31:51', '2022-06-06 09:32:18');
COMMIT;
...
CREATE TABLE `ae_staff_role_relation` (
  `id` int NOT NULL COMMENT '员工角色关系id，自增',
  `staff_id` int unsigned NOT NULL COMMENT '员工id',
  `role_id` int NOT NULL COMMENT '角色id',
  PRIMARY KEY (`id`),
  KEY `srr_role_id_fgk` (`role_id`),
  KEY `srr_staff_id_fgk` (`staff_id`),
  CONSTRAINT `srr_role_id_fgk` FOREIGN KEY (`role_id`) REFERENCES `ae_staff_role` (`id`),
  CONSTRAINT `srr_staff_id_fgk` FOREIGN KEY (`staff_id`) REFERENCES `ae_staff` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `ae_staff_role_relation` VALUES (1, 1, 1);
COMMIT;
...
CREATE TABLE `ae_user` (
  ...
  `type` tinyint unsigned NOT NULL COMMENT '用户类型，0: 管理者，1: 员工',
  `username` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户账户名，每个用户唯一',
  `password` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户密码，加密存储',
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '姓名',
  `eng_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '英文名，非必填，如无可为空',
